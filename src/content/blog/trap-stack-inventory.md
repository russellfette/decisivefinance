---
title: "The trap-stack inventory: mapping which traps are compounding in your portco"
slug: trap-stack-inventory
description: "The Six Traps rarely run solo; they stack and compound. Six live-tests, one per trap, and a score that says when drift has become a stalled portco."
pubDate: 2026-06-02
...
ogImage: "/og/trap-stack-inventory.png"
featured: false
readingTime: 6
---
...
Two stacked traps (two live traps pointing at the same decision or the same line item) is drift. This is the stage where the metrics can still look fine, which is exactly the problem: blended ratios are the certainty illusion's favorite costume, and the dashboard keeps reporting health while the decision ages. We covered that failure mode in [The ratio mirage](https://decisive.finance/perspectives/ratio-mirage-when-metrics-stop-tracking).

Three or more live traps is a stalled portco pattern, the profile investors privately call the walking dead. At three traps the company is not making one bad call; it is running a decision process that can no longer produce calls at all. The full anatomy of that state is in [Inside the stalled portco](https://decisive.finance/perspectives/stalled-portco).
...
- [The ratio mirage: when metrics stop tracking reality](https://decisive.finance/perspectives/ratio-mirage-when-metrics-stop-tracking)
- [Recovery, day 1 to 90](https://decisive.finance/perspectives/stalled-recovery-day-1-to-90)
