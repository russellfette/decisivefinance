---
title: "Fixing margin everywhere means fixing it nowhere"
slug: fix-margin-where-it-lives
description: "Spread a margin push across the whole business and it disappears. One or two lines usually hold most of the gap. Concentrate there, and the value follows."
pubDate: 2026-05-12
...
ogImage: "/og/fix-margin-where-it-lives.png"
featured: true
readingTime: 5
---
...
1. **The subsidized big account.** Large on the top line, negative near the bottom, protected because nobody wants to touch it.
2. **The mispriced flagship.** A product priced years ago on a cost that has since climbed.
3. **The quiet winner starved of attention**, which you should feed, not fix.
4. **The line that drifted**, a former winner turned loser by rising cost and a static price.
...
1. **Rank every line by margin dollars and margin rate.** The gaps announce themselves.
2. **Pick the one or two lines that hold most of the shortfall.** Resist the urge to touch everything.
3. **Act on those first**, re-price, re-mix, or exit, and prove the change holds for a few months.
4. **Only then widen the lens.** A concentrated win funds and justifies the next one.
