---
title: "A few points of margin, run through a multiple, is the biggest lever"
slug: margin-points-through-a-multiple
description: "A point of margin is not a point of value. Run through the multiple, a few points of margin can move the sale price more than a year of revenue growth."
pubDate: 2026-06-02
...
ogImage: "/og/margin-points-through-a-multiple.png"
featured: true
readingTime: 5
---
...
1. **Load full cost and rebuild margin by product, job, and customer.** The blended average hides both the bleeder and the quiet winner.
2. **Find the one or two lines doing the damage.** A single mispriced product or subsidized account usually explains most of the gap.
3. **Re-price or re-mix those lines first.** Concentrated action beats a thin improvement spread across everything.
4. **Prove the new margin holds for a few months.** A buyer pays the multiple on a trend he can believe, not a one-month blip.
