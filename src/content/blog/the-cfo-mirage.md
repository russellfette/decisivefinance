...
1. State the new deliverable explicitly: one Decision Slide per quarter, a Runway Spine monthly, a Signal Dashboard monthly. The close and the deck continue.
2. Offer the CFO a structured runway: 90 days to install the new cadence, with specific checkpoints at day 30 and day 60.
3. If the CFO cannot land the new deliverable inside 90 days, restructure the role. The most common move is to hire or promote a controller, keep the CFO as a senior finance voice, and bring in a fractional finance partner to own the decision cadence.
