...
1. Read-only access to the accounting ledger, SaaS admin consoles, cloud billing portal, AR aging, and the current vendor list.
2. A 30-minute conversation with the CEO and the finance lead to map the last four board decks, the current raise posture, and the decisions that have been sitting open for more than one quarter.
3. An hour with the finance lead alone to walk the chart of accounts and confirm the definition of *customer* currently being used in the monthly reporting.
