---
title: "The five findings that re-trade a deal in diligence"
slug: five-findings-that-retrade-a-deal
description: "Deals rarely die on price. They re-trade when a buyer's analyst finds one of five things in the numbers. Every one is a seller-side problem with a seller-side fix."
pubDate: 2026-09-08
...
ogImage: "/og/five-findings-that-retrade-a-deal.png"
featured: false
readingTime: 6
---
...
1. **A margin that moves when you look closely.** Gross margin that swings month to month, or a blended figure that falls apart when split by product or customer, tells a buyer the earnings aren't understood. He discounts what isn't understood.
2. **Revenue recognized inconsistently.** The same kind of sale booked one way early in the year and another way later. Every dollar can be real and the top line still becomes untrustworthy, because the trend rests on a policy that changed.
3. **Add-backs that don't survive.** A padded schedule of adjustments, half of which get struck on sight. Each strike lowers the number and lowers trust in the rest.
4. **Cash and revenue that don't tie out.** Money received and never matched to its purpose, or working capital that can't be reconstructed, forces the buyer to assume the worst and price it in.
5. **A company that can't run without the owner.** When every pricing, hiring, and customer decision routes through one person, the buyer re-rates the risk and the multiple, because he's buying dependence, not a system.
