...
We wrote about that window in [the 18-month mark](https://decisive.finance/perspectives/eighteen-month-mark), and about the full pattern in [the stalled portco pillar](https://decisive.finance/perspectives/stalled-portco). The trap mechanics behind the signals are in [the trap-stack inventory](https://decisive.finance/perspectives/trap-stack-inventory).

## How do you know which one you are?

Count the signals against your own numbers, not your narrative. The fastest honest way to do that is [the Next Call Self-Assessment](https://decisive.finance/assessment/next-call/): six screens, your numbers against the post-Series A and B cohort, a board-grade read on where you sit between the growth your board wants and the runway your bank wants. Six minutes, and the dashboard is yours either way.

Related reading:

- [The stalled portco: what it is, how to spot it, how to come back](https://decisive.finance/perspectives/stalled-portco)
- [The 18-month mark](https://decisive.finance/perspectives/eighteen-month-mark)
