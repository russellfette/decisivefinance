---
title: "Count backward from your sale date, then start now"
slug: count-backward-from-your-sale-date
description: "Pick the year you want to sell, subtract the twelve believable months a buyer needs, then subtract the time to make the numbers true. The start date is usually now."
pubDate: 2026-05-19
...
ogImage: "/og/count-backward-from-your-sale-date.png"
featured: true
readingTime: 5
---
...
1. **Start with the year you want to sell.** Be specific. A vague "someday" cannot be planned against.
2. **Subtract twelve months.** A buyer underwrites a trailing twelve he can believe, so your numbers must already be true a full year before you go to market.
3. **Subtract the time to make the numbers true.** Fixing costing, rebuilding the close, making revenue recognition consistent, and cleaning the balance sheet is months of work, not a weekend.
4. **Subtract a buffer for the process itself.** Marketing the business and closing takes its own months after the trailing twelve is ready.
...
1. **If the start date is now or past, begin.** The numbers are the long pole, and delay only pushes the sale out.
2. **Sequence truth first, process second.** You cannot market a trailing twelve you have not built.
3. **Revisit the count each year.** As the target moves, the start date moves with it.
