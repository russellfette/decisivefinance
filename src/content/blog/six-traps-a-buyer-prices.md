---
title: "The six traps a buyer prices against you"
slug: six-traps-a-buyer-prices
description: "Value doesn't get trapped by accident. It gets trapped by six decision patterns, and a buyer discounts every one he finds. Here's the diagnostic, read through a buyer's eyes."
pubDate: 2026-08-18
...
ogImage: "/og/six-traps-a-buyer-prices.png"
featured: false
readingTime: 7
---
...
1. **Sunk cost.** Money already spent gets a vote it hasn't earned. The product line nobody will kill because of what's already in it. A buyer sees a resource drain kept alive by history and prices the drag, not the hope.
2. **Status quo.** The pricing, the vendor, the customer terms nobody has revisited because they've always been that way. A buyer sees margin left on the table and wonders what else went unexamined.
3. **Mental accounting.** Treating dollars differently based on which bucket they sit in, so a subsidized customer or a money-losing line survives because it's counted in the wrong column. A buyer re-sorts every bucket and the story changes.
4. **Anchoring.** A number set once, long ago, that everything still references. A price anchored to an old cost, a budget anchored to a year that no longer exists. A buyer marks the anchor as stale and discounts the decisions built on it.
5. **Loss aversion.** Holding a loser to avoid booking the loss, which reads to a buyer as a management team that won't make the hard call. He prices in the calls you haven't made.
6. **Certainty illusion.** Confidence in a number that isn't actually supported, usually a margin or a forecast that feels solid and can't be defended when pressed. This is the most expensive trap in diligence, because it's where an owner gets caught believing his own mirage.
