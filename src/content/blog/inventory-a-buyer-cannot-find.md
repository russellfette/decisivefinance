---
title: "The inventory on your books that a buyer cannot find"
slug: inventory-a-buyer-cannot-find
description: "A balance sheet can carry inventory and prepaid value that is not really there. Here is how a buyer finds roughly $57,600 of it, and what it costs you."
pubDate: 2026-07-21
...
1. **Count the high-value inventory and tie it to the ledger.** If the floor and the books disagree, the books are wrong until proven otherwise.
2. **Write down dead stock when it dies, not when a buyer finds it.** Stock that has not moved in a year is a loss you already took. Recording it only makes the number true.
3. **Draw prepaids down against real usage.** A prepaid balance that never moves is a balance nobody is checking.
4. **Reconcile every balance sheet account to something outside the books.** A bank statement, a contract, a physical count. An account that ties only to itself is where phantom value hides.
5. **Make one person own the answer.** Not "the balance sheet balances," but "every asset on it is real, and here is what backs it."
